...
export default async function ProductPage() {
  ...
  const { parent, children } = await getModuleWithChildren("product");
  ...
  const filteredChildren = children.filter((child) => {
    if (child.code === "categories" && !userPermissions.includes("menu:categories")) {
      return false; 
    }

    if (child.code === "product_details" && !userPermissions.includes("menu:product_details")) {
      return false; 
    }
