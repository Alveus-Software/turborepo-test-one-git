...
import {
  createCategory,
  updateCategoryImage,
} from "@repo/lib/actions/category.actions";
import type { ProductCategory } from "@repo/components/dashboard/categorias/category-list";
import CategoryForm from "@repo/components/dashboard/categorias/category-form";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (typeof formData.image_url !== "string" && formData.image_url) {
        ...
        // console.log("Resultado para subir: ",uploadResult);
