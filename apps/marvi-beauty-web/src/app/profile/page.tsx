...
import { UserCircle, Mail, Shield, CheckCircle, XCircle, Clock, TrendingUp, Edit2, Check, X, KeyRound} from 'lucide-react';
...
export default function ProfilePage(){
    ...
    const [checkingPasswordPermissions, setCheckingPasswordPermissions] = useState(false);
    ...
    if(!userProfile){
        return(
            <div className="min-h-screen flex items-center justify-center bg-background pt-20"> {/* Agregar pt-20 aquí también */}
        ...
        <div className="container mx-auto px-4 py-12 max-w-6xl">
          ...
          <Card className="p-8 mb-8 border-2 shadow-lg">
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
              <div className="flex items-center justify-center w-24 h-24 rounded-full bg-gradient-to-br from-amber-500 to-amber-600 shrink-0 shadow-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <Card className="p-6 border-2 shadow-md hover:shadow-lg transition-shadow">
              <div className="flex items-center gap-4">
                <div className={`p-3 rounded-lg ${userProfile.active ? 'bg-green-500/10' : 'bg-red-500/10'}`}>
                  {userProfile.active ? (
                ...
                <div className="flex items-start justify-between p-4 bg-muted/50 rounded-lg">
                  <div className="flex-1">
                    <Button
                      ...
                      className="h-8 px-3 flex items-center gap-2 text-amber-500 hover:text-amber-600"
                    >
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-5">
                  ...
                  <div className="pb-6 flex-1">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      {new Date(userProfile.created_at).toLocaleTimeString("es-ES", {
                        hour: "2-digit",
                        minute: "2-digit",
                      })}
                    </p>
                ...
                <div className="flex gap-5">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      {new Date(userProfile.updated_at??'').toLocaleTimeString("es-ES", {
                        hour: "2-digit",
                        minute: "2-digit",
                      })}
                    </p>
