    ...
    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mt-6 px-4 sm:px-0">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="px-3 py-2 border border-custom-border-primary rounded-md text-sm font-medium text-custom-text-secondary hover:bg-custom-accent-hover disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
          ...
          {!visiblePages.includes(1) && (
            <>
              <button
                ...
                className="px-3 py-1 border border-custom-border-primary rounded-md text-sm font-medium text-custom-text-secondary hover:bg-custom-accent-hover disabled:opacity-50 disabled:cursor-not-allowed"
              >
                1
              </button>
              {!visiblePages.includes(2) && (
                <span className="px-3 py-1 text-custom-text-disabled">...</span>
              )}
            </>
          )}
            ...
            <button
              ...
              className={`px-3 py-1 border rounded-md text-sm font-medium ${
                page === currentPage
                  ...
                  : "border-custom-border-primary text-custom-text-secondary hover:bg-custom-accent-hover"
