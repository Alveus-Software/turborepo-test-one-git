  ...
  return (
    <div className="max-w-4xl mx-auto">
      <form
        ...
        className="space-y-6 bg-[#0A0F17] rounded-lg border border-gray-800 p-6"
      >
        {/* Información Básica */}
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full border border-gray-700 rounded-lg px-3 py-2 focus:outline-none focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400 focus:ring-opacity-50 text-white bg-[#070B14] placeholder-gray-500 uppercase"
            ...
            <div className="relative" ref={dropdownRef}>
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 border border-gray-700 rounded-lg px-3 py-2 focus:outline-none focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400 focus:ring-opacity-50 text-white bg-[#070B14] placeholder-gray-500"
                />
