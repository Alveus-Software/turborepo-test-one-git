// components/dashboard/empresas/company-children-list.tsx (actualizado)
"use client";
    ...
    return (
      <div className="space-y-4">
        ...
        {[...Array(3)].map((_, idx) => (
          <div
            key={idx}
            className="h-20 bg-gray-800/30 rounded animate-pulse"
          ></div>
        ))}
      </div>
    );
        ...
        {filteredChildren.length === 0 ? (
          ...
          <div className="space-y-3">
            {filteredChildren.map((company) => (
              <div
                key={company.id}
                className="group bg-[#0A0F17] border border-gray-800 rounded-lg hover:border-gray-700 transition-all overflow-hidden"
              >
                <div className="p-4">
                  <div className="flex justify-between items-start">
                    ...
                    {onRemoveAffiliation && (
                      <button
                        ...
                        className="ml-3 p-2 text-red-400 hover:text-red-300 hover:bg-red-400/10 rounded-lg transition-colors"
