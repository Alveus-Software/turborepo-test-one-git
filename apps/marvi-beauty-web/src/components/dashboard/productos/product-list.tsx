...
} from "@repo/lib/actions/product.actions";
import {
  Select,
  SelectContent,
  SelectItem,
      ...
      <div className="flex flex-col md:flex-row gap-3 mb-4">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 md:py-2 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-base"
          />
        </div>
      ...
      <div className="mb-6">
        ...
        {hasActiveFilters && (
          <div className="flex flex-wrap gap-2 mb-3">
            {categoryFilter !== "all" && (
              <span className="inline-flex items-center gap-1 px-3 py-1 text-xs font-medium text-blue-700 bg-blue-50 border border-blue-200 rounded-full">
                Categoría:{" "}
            ...
            {statusFilter !== "all" && (
              <span className="inline-flex items-center gap-1 px-3 py-1 text-xs font-medium text-orange-700 bg-orange-50 border border-orange-200 rounded-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger
                    id="category-filter"
                    className="h-10 bg-white border-gray-300 hover:border-gray-400 transition-colors"
                  >
