    ...
    return (
      <div className="space-y-4 sm:space-y-6 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        {[...Array(3)].map((_, idx) => (
          <div
            key={idx}
            className="animate-pulse flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-gray-700 rounded-lg shadow-xs border border-gray-200 p-4"
          >
            {/* Contenedor de imagen y texto */}
            <div className="flex items-center space-x-4">
              {/* Imagen */}
              <div className="h-10 w-10 sm:h-12 sm:w-12 bg-gray-700 rounded-full" />
