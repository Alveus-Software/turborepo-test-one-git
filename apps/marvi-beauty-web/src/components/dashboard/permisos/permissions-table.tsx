...
export default function PermissionsTable({
  ...
  return (
    <div className="space-y-4">
        ...
        <div className="w-full md:w-64">
          <Select value={currentModule} onValueChange={handleModuleChange}>
            ...
            <SelectContent className="bg-background border border-border text-foreground">
              <SelectItem
                value=" "
                className="text-base hover:bg-muted hover:text-accent-foreground"
              >
                Todos los módulos
              </SelectItem>
      ...
      {/* Loading skeleton */}
      {isPending && initialData.permissions.length === 0 && (
        <>
          {/* Skeleton Desktop */}
            ...
            <div className="animate-pulse">
              <div className="bg-gray-100 px-6 py-3 flex justify-between items-center text-gray-700">
                <div className="flex gap-4">
                  ...
                  <div className="h-4 bg-gray-300 rounded-sm w-48"></div>
              ...
              {[...Array(5)].map((_, i) => (
                ...
                >
                  <div className="flex gap-8 items-center">
                    ...
                    <div className="h-4 bg-gray-200 rounded-sm w-64"></div>
              ...
              <thead className="bg-[#f5f0ed] text-[#987E71]">
                <tr>
                  <th
                    ...
                    className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider cursor-pointer hover:bg-[#e8dfd9] select-none"
                  >
                    <div className="flex items-center gap-2">
                      Nombre
                      {getSortIcon("name")}
                      ...
                      {(canUpdate || canDelete) && (
                        <td className="px-6 py-4 whitespace-nowrap text-right">
                          <Popover
                            ...
                            onOpenChange={(isOpen) =>
                              setOpenPopoverId(isOpen ? permission.id : null)
                            }
                          >
                            ...
                            <PopoverContent className="w-40 p-2" align="end">
                              {canUpdate && (
                                <Link
                                  href={
                                    "/dashboard/seguridad/permisos/editar/" +
                                    permission.id
                                  }
                                >
                                  <button className="w-full text-left px-3 py-2 text-sm text-gray-700 hover:bg-[#f5f0ed] rounded-md">
                                    Editar
                                  </button>
                                </Link>
                              )}
                          ...
                          <PopoverContent className="w-40 p-2" align="end">
                            {canUpdate && (
                              <button
                                onClick={() =>
                                  router.push(
                                    `/dashboard/seguridad/permisos/editar/${permission.id}`,
                                  )
                                }
                                className="w-full text-left px-3 py-2 text-sm text-gray-700 hover:bg-[#f5f0ed] rounded-md"
                              >
                                Editar
                              </button>
                            )}
