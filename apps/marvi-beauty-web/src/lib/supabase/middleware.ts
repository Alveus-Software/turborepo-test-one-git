...
export async function updateSession(request: NextRequest) {
  ...
  if (user) {
    ...
    if (
      userData.profile_id === "16a00990-a80e-44c8-8580-4faa17438609" &&
    ...
    const protectedRoutes: { path: string; permission: string }[] = [
      ...
      {
        path: "/dashboard/reportes/inventario",
        permission: "menu:inventories_reports",
      },
      {
      ...
      {
        path: "/dashboard/inventarios/reporte_inventario",
        permission: "read:inventories_reports",
      },
