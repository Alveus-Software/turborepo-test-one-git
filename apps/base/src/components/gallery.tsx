import { Card } from "@repo/ui/card2";
import { AnimatedText } from "@repo/components/animations/animated-text";
import { AnimatedCard } from "@repo/components/animations/animated-card";
