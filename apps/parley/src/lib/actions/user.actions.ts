...
// export async function getUserWithHierarchy(userId: string): Promise<UserDetail | null> {
//   try {
//     const supabase = await createClient()
...
//     // Adaptamos el retorno para que la jerarquía esté al mismo nivel si es necesario
//     if (data) {
//       return {
//         ...data,
//       }
