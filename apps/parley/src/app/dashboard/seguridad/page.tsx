  ...
  if (!parent) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-yellow-50">
        <p className="text-yellow-800">Módulo no encontrado</p>
      </div>
    );
  }
    ...
    <div >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12">
          <div className="flex items-center gap-4 mb-3">
            ...
            <div>
              ...
              <p className="text-yellow-600 mt-1">{parent.description}</p>
            </div>
          </div>
        </div>
        ...
        {filteredChildren.length > 0 ? (
          ...
          <div className="bg-white rounded-2xl p-12 border border-yellow-200 text-center">
            <FolderOpen className="w-16 h-16 text-yellow-300 mx-auto mb-4" />
            <p className="text-yellow-500">No hay módulos disponibles</p>
          </div>
        )}
      </div>
    </div>
