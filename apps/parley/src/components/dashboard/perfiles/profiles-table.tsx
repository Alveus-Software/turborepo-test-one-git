            ...
            <table className="min-w-full divide-y divide-[#f5efe6]">
              ...
              <tbody className="bg-white divide-y divide-[#f5efe6]">
                {initialData.profiles.length === 0 ? (
                  <tr>
                    <td colSpan={4} className="px-6 py-4 text-center text-neutral-600">
                      No se encontraron perfiles
                    </td>
                  </tr>
                ) : (
                  initialData.profiles.map((profile) => (
                    <tr key={profile.id} className="hover:bg-[#faf8f3] transition-colors duration-200">
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-neutral-700 font-mono mb-2">
                        {profile.code}
                      </p>
                      <span
                        className={`px-2.5 py-1 inline-flex items-center text-xs font-semibold rounded-full ${
