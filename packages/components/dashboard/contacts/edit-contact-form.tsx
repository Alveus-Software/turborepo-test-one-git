...
import { getContactById, updateContact } from "@repo/lib/actions/contact.actions";
  ...
  if (initialLoading) {
    return (
      <div className="max-w-2xl mx-auto">
        ...
        <div className="animate-pulse bg-card rounded-lg border border-border p-6 space-y-4">
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <form
        ...
        className="space-y-6 bg-card rounded-lg border border-border p-6"
      >
        {/* Información Básica */}
            ...
            {selectedUser ? (
              <div className="p-3 bg-green-500/10 border border-green-500/30 rounded-lg">
                <p className="text-sm text-green-600 dark:text-green-400">
                  ...
                  {!selectedUser.active && (
                    <span className="text-amber-600 dark:text-amber-400 ml-2">• Inactivo</span>
                  )}
                </p>
              </div>
              ...
              !formData.related_user_id && (
                <div className="p-3 bg-muted border border-input rounded-lg">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <input
                ...
                onChange={handleChange}
                className="flex-1 border border-input rounded-lg px-3 py-2 focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary focus:ring-opacity-50 text-foreground bg-background"
            ...
            {errors.birth_date && (
              <p className="text-destructive text-sm">{errors.birth_date}</p>
            )}
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              />
              {errors.rfc && (
                <p className="text-destructive text-sm">{errors.rfc}</p>
              )}
            </div>
