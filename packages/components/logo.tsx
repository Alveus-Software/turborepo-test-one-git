...
export const LogoAlveus = ({ className }: { className?: string }) => {
  return (
    <img
      src="/assets/landing/logo_alveus_svg.svg" 
      alt="Logo"
...
export const LogoAlveusMini = ({ className }: { className?: string }) => {
  return (
    <img
      src="/assets/landing/logo_alveus_mini.svg" 
      alt="Logo"
      className={cn('h-5 w-auto', className)}
    />
  );
...
export const LogoNavidad = ({ className }: { className?: string }) => {
  return (
    <img
      src="/assets/landing/logo_navidad.png" 
      alt="Logo"
      className={cn('h-5 w-auto', className)}
    />
  );
...
export const LogoNavidadMini = ({ className }: { className?: string }) => {
  return (
    <img
      src="/assets/landing/logo_navidad_mini.png" 
      alt="Logo"
      className={cn('h-5 w-auto', className)}
    />
  );
...
export const LogoParley = ({ className }: { className?: string }) => {
  return (
    <img
      src="/assets/landing/logoparley.png"
