...
import WhatsAppForm from "@repo/components/dashboard/numero-whatsapp/whatsapp-form";
...
export default function EditWhatsAppPagePackage() {
  ...
  const validateForm = () => {
    ...
    if (!digitsOnly.trim()) {
      newErrors.phone_number = "El número de WhatsApp es obligatorio";
  ...
  <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div className="mb-6">
      <h1 className="text-2xl sm:text-3xl font-bold text-[#1F2937] flex items-center gap-3">
        ...
        {configId ? "Editar Configuración WhatsApp" : "Nueva Configuración WhatsApp"}
      </h1>
      <p className="text-[#4B5563] mt-2">
        Configura tu número de WhatsApp Business para recibir mensajes de clientes
      </p>
    </div>
        {/* Formulario */}
        <WhatsAppForm
