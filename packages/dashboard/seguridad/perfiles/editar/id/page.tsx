...
import { getOneProfile, updateProfile } from '@repo/lib/actions/profile.actions';
import ProfileForm from '@repo/components/dashboard/perfiles/profile-form';
import { ProfileFormSkeleton } from '@repo/components/dashboard/perfiles/profile-skeleton';

export default function EditProfilePagePackage() {
  ...
  return (
    <div className="bg-custom-bg-primary">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-custom-text-primary">Actualizar Perfil</h1>
        </div>
