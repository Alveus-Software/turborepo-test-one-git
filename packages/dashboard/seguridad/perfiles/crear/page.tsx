...
import { createProfile } from '@repo/lib/actions/profile.actions';
...
export default function CreateProfilePagePackage() {
  ...
  return (
    <div className="bg-custom-bg-primary">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-custom-text-primary">Crear Perfil</h1>
        </div>
