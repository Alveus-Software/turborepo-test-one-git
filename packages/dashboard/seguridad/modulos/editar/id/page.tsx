...
import {
  ...
  getParentModules,
  updateModule,
} from "@repo/lib/actions/module.actions";
import { type Module, type NewModulePayload } from "@repo/lib/utils/definitions";
import { toast } from "sonner";
import { ModuleFormSkeleton } from "@repo/components/dashboard/modulos/module-form-skeleton";
import ModuleForm from "@repo/components/dashboard/modulos/module-form";

export default function EditModulePagePackage() {
  ...
  return (
    <div className="min-h-screen bg-custom-bg-primary">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Título */}
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-custom-text-primary">Editar Módulo</h1>
        </div>
