...
import AttendanceUsersTable from '@repo/components/attendance/attendance-users-table'
...
export default async function AttendanceUsersPagePackage({ searchParams }: PageProps) {
