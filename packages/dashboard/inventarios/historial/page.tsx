...
import MovementsTable from "@repo/components/dashboard/inventarios/movements-table";
...
export default async function MovementsPagePackage({ searchParams }: PageProps) {
