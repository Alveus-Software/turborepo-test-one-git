...
export default async function InventoriesPagePackage() {
  ...
  const { parent, children } = await getModuleWithChildren("taxes");
  ...
  const filteredChildren = children.filter((child) => {
    if (
      child.code === "tax_management" &&
      !userPermissions.includes("menu:tax_management")
    ) {
      return false;
    }
    // if (
    //   child.code === "departure_registration" &&
    //   !userPermissions.includes("menu:departure_registration")
    // ) {
    //   return false;
    // }
