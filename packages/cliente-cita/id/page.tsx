...
import DateStep from "@repo/components/customer-appointment/date-step";
import InfoStep from "@repo/components/customer-appointment/info-step";
import ConfirmationStep from "@repo/components/customer-appointment/confirmation-step";
import SummaryPanel from "@repo/components/customer-appointment/summary-panel";
...
export default function ProfesionalAppointmentPagePackage() {
    ...
    return (
      <div className="min-h-screen bg-[#faf8f3] flex items-center justify-center">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#c6a365] mx-auto mb-4"></div>
          <p className="text-neutral-700 mb-2">Buscando profesional...</p>
  ...
  if (!spaceOwnerId) {
    return (
      <div className="min-h-screen bg-[#faf8f3] flex items-center justify-center">
        <div className="text-center">
          <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-[#fdeaea] flex items-center justify-center">
            <ArrowLeft className="w-8 h-8 text-[#c62828]" />
          </div>
          ...
          <p className="text-[#c6a365] font-mono mb-6">{profesionalCode}</p>
          <Button
  ...
  return (
    <div className="min-h-screen bg-[#faf8f3]">
      {/* Header Mobile */}
      <div className="lg:hidden bg-white border-b border-[#f5efe6] sticky top-0 z-10">
        <div className="px-4 py-4">
          <div className="flex items-center justify-between">
            <button
              onClick={() => router.push("/cliente-cita")}
              className="flex items-center gap-2 text-neutral-600 hover:text-neutral-900 transition-colors flex-shrink-0"
            >
            ...
            <div className="flex-1 flex flex-col items-center mx-2">
              <h1 className="text-lg font-serif font-semibold text-neutral-900 text-center whitespace-nowrap truncate">
            ...
            <div className="w-14 flex-shrink-0 flex justify-end">
              {user ? (
                <Link href="/profile" className="flex items-center">
                  <span className="text-xs text-[#c6a365] font-medium hidden sm:inline">
                    Perfil
                  </span>
                </Link>
              ) : (
      ...
      {/* Header Desktop */}
      <div className="hidden lg:block bg-white border-b border-[#f5efe6]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <h1 className="text-3xl font-serif font-semibold text-neutral-900">
                Reservar cita con{" "}
                <span className="text-[#c6a365]">{profesionalName}</span>
              </h1>
            ...
            <div className="flex gap-3">
              <Link href="/cliente-cita">
                <Button
                  variant="outline"
                  className="border-[#e6dcc9] text-neutral-700 hover:bg-[#f5efe6] hover:text-neutral-900"
                >
                  Ver todos los profesionales
                </Button>
              </Link>
              {user ? (
                ...
                <Link href="/auth/login">
                  <Button className="bg-[#c6a365] hover:bg-[#b59555] text-white">
                    Iniciar sesión
                  </Button>
                </Link>
              )}
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 xl:px-8 py-6 lg:py-8">
        <div className="grid xl:grid-cols-3 gap-4 lg:gap-6 xl:gap-8">
